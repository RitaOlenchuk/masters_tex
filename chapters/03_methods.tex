...
The reproduction of shape contours remains difficult, hence latest DeepLabv3+~\cite{chen2018encoder} improves DeepLabv3~\cite{chen2017rethinking} with the encoder-decoder structure (Figure~\ref*{fig:deeplab}).
As a result DeepLabv3+ contains rich semantic information from the encoder module,
while the detailed object boundaries are recovered by decoder module and the spatial information is recovered.
